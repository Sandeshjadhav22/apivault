      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <Card>
            ...
            <CardContent>
              Your API keys are encrypted and stored securely, ensuring maximum
          ...
          <Card>
            ...
            <CardContent>
              Designed with developers in mind, offering a simple and intuitive
              interface for managing your API keys.
            </CardContent>
          </Card>
        </div>
      </div>
